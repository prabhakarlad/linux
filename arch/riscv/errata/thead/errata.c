...
static void thead_cmo_wback(void *vaddr, unsigned long size)
{
...
static void thead_cmo_inv(void *vaddr, unsigned long size)
{
	unsigned long addr = (unsigned long)vaddr;
...
static void thead_cmo_wback_inv(void *vaddr, unsigned long size)
{
	unsigned long addr = (unsigned long)vaddr;
...
static const struct riscv_cache_ops thead_cmo_ops = {
	.dma_cache_wback = &thead_cmo_wback,
	.dma_cache_inv = &thead_cmo_inv,
	.dma_cache_wback_inv = &thead_cmo_wback_inv,
};
